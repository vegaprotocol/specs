...
- A governance proposal to close a market which doesn't specify the final settlement price gets rejected buy the markets which require it (non-spot). (<a name="0028-GOVE-108" href="#0028-GOVE-108">0028-GOVE-108</a>)
- When multiple market closure governance proposals are submitted and accepted then one to arrive last is the one whose enactment time and final settlement price get used to close the market (<a name="0028-GOVE-109" href="#0028-GOVE-109">0028-GOVE-109</a>)
...
- Governance vote to suspend a market that's currently in continuous trading mode puts it into auction mode at vote enactment time. The only way to put the market back into continuous trading mode is with a successful governance vote to unsuspend the market. (<a name="0028-GOVE-112" href="#0028-GOVE-112">0028-GOVE-112</a>)
- Governance vote to suspend a market that's currently in auction trading mode keeps it in auction mode at vote enactment time. Even if the trigger that originally put the market into auction mode is no longer violated the market must remain in auction. (<a name="0028-GOVE-113" href="#0028-GOVE-113">0028-GOVE-113</a>)
- Unsuspending a market with other auction triggers active does not put it out of auction until those triggers allow to do so. (<a name="0028-GOVE-114" href="#0028-GOVE-114">0028-GOVE-114</a>)
- A market suspended by the governance vote does not allow trade generation of margin account balance reduction. (<a name="0028-GOVE-115" href="#0028-GOVE-115">0028-GOVE-115</a>)
