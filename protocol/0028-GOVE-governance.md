...
- A market change proposal that's to modify the market name on a market in any state will be accepted and if it's the enactment time happens to be before the opening auction ends then the proposed modification is enacted. (<a name="0028-GOVE-159" href="#0028-GOVE-159">0028-GOVE-159</a>)
