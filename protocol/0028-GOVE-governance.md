...
- Enacting a market closure governance proposal on a market which is in opening auction cancels it immediately without generating any trades. The market moves to a cancelled state and any open trades are also cancelled. (<a name="0028-GOVE-135" href="#0028-GOVE-135">0028-GOVE-135</a>)
