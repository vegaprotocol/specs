...
1. Messages are accepted that contain the data and the signature (conforming to the Open Oracle specification) Note: do not support (or need to) direct connections to REST APIs, Ethereum smart contracts, etc. conforming to the open oracle spec. (<a name="0046-COSMICELEVATOR-017" href="#0046-COSMICELEVATOR-017">0046-COSMICELEVATOR-017</a>)
