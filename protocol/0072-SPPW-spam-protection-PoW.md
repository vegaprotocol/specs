...
- A PoW proof can be pre-computed by the submitting party using chain ID and block hash and attached to any valid transaction, provided that at time of submission the block hash is one of the last `spam.pow.numberOfPastBlocks` blocks.  (<a name="0072-SPPW-007" href="#0072-SPPW-007">0072-SPPW-007</a>)
