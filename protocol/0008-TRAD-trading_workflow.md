...
1. Following all of the matching of trades resulting from a single order or the acceptance of an order onto the order book, there may be a change to the Mark Price.  (<a name="0008-TRAD-003" href="#0008-TRAD-003">0008-TRAD-003</a>) for product spot: (<a name="0008-TRAD-008" href="#0008-TRAD-000">0008-TRAD-008</a>)
