...
- [GTC/GTT/GFA](./0014-ORDT-order_types.md#time-in-force--validity)
  ...
  - [LIMIT: POST-ONLY TRUE](./0014-ORDT-order_types.md#order-pricing-methods) orders are placed into the book and no matching takes place. (<a name="0068-MATC-041" href="#0068-MATC-041">0068-MATC-041</a>)
