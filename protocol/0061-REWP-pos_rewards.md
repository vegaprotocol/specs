...
1. Chanfe of network parsmeter 'reward.staking.delegation.delegatorShare' to 0 (no reward for delegators, 0.99, and 0.5. The share for delegators at the end of the epochs changes accordingly.  (<a name="0061-REWP-011" href="#0061-REWP-011">0061-REWP-011</a>) 
