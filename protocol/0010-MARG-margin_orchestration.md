...
1. [ ] Maintenance margin is correctly calculated for a party with orders / positions when obtaining risk factors from the lognormal risk model under various different parameters: In particular we see that 
    - maintenance margin obtained when sigma is 1.0 is lower than maintenance margin obtained when sigma is  (<a name="0010-MARG-012" href="#0010-MARG-012">0010-MARG-012</a>) 
    - maintenance margin obtained when tau is 1.0/365.25/24 is lower than maintenance margin obtained when sigma is 1.0/365.25/24/12 (<a name="0010-MARG-013" href="#0010-MARG-013">0010-MARG-013</a>)
