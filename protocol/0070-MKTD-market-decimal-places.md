...
- Assert that the settlement calculation can be correctly calculated when:
  - The market settlement asset precision >= than the settlement asset (<a name="0070-MKTD-018" href="#0070-MKTD-018">0070-MKTD-018</a>)
  - The market settlement asset precision <= than the settlement asset (<a name="0070-MKTD-019" href="#0070-MKTD-019">0070-MKTD-019</a>)
