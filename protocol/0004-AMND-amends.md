...
- Price change amends specifying a new price which is not an integer multiple of the markets tick size should be rejected and the original order should be left in place (<a name="0004-AMND-060" href="#0004-AMND-060">0004-AMND-060</a>).
