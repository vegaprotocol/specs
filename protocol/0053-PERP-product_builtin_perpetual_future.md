...
Perps market can be created with [hardcoded risk factors](./0018-RSKM-quant_risk_models.ipynb). (<a name="0053-PERP-047" href="#0053-PERP-047">0053-PERP-047</a>)

Updating a risk model on a perps market with [hardcoded risk factors](./0018-RSKM-quant_risk_models.ipynb) results in recalculation of all margin levels in line with hardcoded values and collateral search/release where appropriate. (<a name="0053-PERP-048" href="#0053-PERP-048">0053-PERP-048</a>)
