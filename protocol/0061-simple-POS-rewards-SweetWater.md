...
1. Obtain the performance score as per [validator performance specification](064-validator-performance-based-rewards.md). Update `validatorScore <- validatorScore x performance_score`. 
