...
- A network disposal order can cross with orders outside price monitoring bounds. If it does it must enter the auction at price one tick past the price monitoring bound (for volume which was determined as the disposal volume for that step).  (<a name="0012-POSR-030" href="#0012-POSR-030">0012-POSR-030</a>)
