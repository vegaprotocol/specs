...
1. order should be rejected when submit a limit order, no match, added to the book, party can't cover the amount that needs to be transfered to the holding account.(<a name="0080-SPOT-028" href="#0080-SPOT-028">0080-SPOT-028</a>)
