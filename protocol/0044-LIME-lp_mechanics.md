...
- Boundary values are respected for the network parameters
  ...
  - `market.liquidity.providers.feeCalculationTimeStep` valid values: `>0`, `<= validators.epoch.length` default value of `60m` (<a name="0044-LIME-100" href="#0044-LIME-100">0044-LIME-100</a>)
