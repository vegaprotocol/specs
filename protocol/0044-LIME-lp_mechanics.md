...
- For a market that is in continuous trading and a single LP has committed liquidity:
  ...
  -  When LP decreases its commitment so that $\text{commitment-variation}_i <= \text{maximum-penalty-free-reduction-amount}_i$, then the entire amount by which they decreased their commitment is transferred to their general account, their ELS got updated as per the [ELS calculation](0042-LIQF-setting_fees_and_rewarding_lps.md)(<a name="0044-LIME-075" href="#0044-LIME-075">0044-LIME-075</a>) for spot (<a name="0044-LIME-076" href="#0044-LIME-076">0044-LIME-076</a>)
  - When LP decreases its commitment so that $\text{commitment-variation}_i > \text{maximum-penalty-free-reduction-amount}_i$ , $(1-\text{market.liquidity.earlyExitPenalty}) \cdot \text{penalty-incurring-reduction-amount}_i$ should be transfered into its general account and $\text{market.liquidity.earlyExitPenalty} \cdot  \text{penalty-incurring-reduction-amount}_i$ should be transfered into market insurance pool (<a name="0044-LIME-077" href="#0044-LIME-077">0044-LIME-077</a>) for spot $\text{market.liquidity.earlyExitPenalty} \cdot  \text{penalty-incurring-reduction-amount}_i$ should be transfered into the network treasury for the asset (<a name="0044-LIME-078" href="#0044-LIME-078">0044-LIME-078</a>)
