...
1. The market's [insurance pool balance is transferred](./0015-INSR-market_insurance_pool_collateral.md) into the global insurance pool using the same settlement asset.
