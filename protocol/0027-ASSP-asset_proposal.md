...
- If an update asset proposal passed and it changes `quantum` *only* then this new value becomes used immediately on enactment. (<a name="0027-ASSP-025" href="#0027-ASSP-025">0027-ASSP-025</a>)
