...
1. When proposing a new market if the triggering_ratio is not supplied then the current value of market.liquidity.targetstake.triggering.ratio is used in its place. (<a name="0035-LIQM-011" href="#0035-LIQM-010">0035-LIQM-011</a>)
