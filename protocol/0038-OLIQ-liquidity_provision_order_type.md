...
- Change of `market.liquidity.minimum.probabilityOfTrading.lpOrders` will immediately change the minimum probability of treading in LP orders. Hence the LP orders created from liquidity commitments that fall below this probability will be immediately repriced. (<a name="0038-OLIQ-007" href="#0038-OLIQ-007">0038-OLIQ-007</a>)
