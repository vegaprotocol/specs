...
-`fully-collateralised mode` setting to `true` should be rejected if `binary_settlement` is set to `false`, `fully-collateralised mode` setting to `true` should be accepted if `binary_settlement` is set to `true` (<a name="0019-MCAL-159" href="#0019-MCAL-159">0019-MCAL-159</a>)
