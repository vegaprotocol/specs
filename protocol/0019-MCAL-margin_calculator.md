...
- When the party place a new long order of `1` with price `145000` and the party has existing short position of `3`, and the market is in continouse trading. The margin account should not change(<a name="0019-MCAL-038" href="#0019-MCAL-038">0019-MCAL-038</a>)

- When the party place a new long order of `10` with price `145000` and the party has existing short position of `3`, and the market is in continouse trading. The margin account should have additional amount `limit price * size * margin factor = 145000 x (10-3) x 0.3 = 304500` added if the party has enough asset in the general account(<a name="0019-MCAL-039" href="#0019-MCAL-039">0019-MCAL-039</a>)
