...
- A party with a parked pegged order switches from cross margin mode to isolated margin mode, the parked pegged order is cancelled (<a name="0019-MCAL-143" href="#0019-MCAL-143">0019-MCAL-143</a>)
