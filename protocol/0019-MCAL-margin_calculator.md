...
- when switch to isolated margin mode, valid value of the margin factor must be greater than 0, and also greater than `max(risk factor long, risk factor short)`(<a name="0019-MCAL-208" href="#0019-MCAL-208">0019-MCAL-208</a>)
...
The margin factor must be greater than 0, and also greater than `max(risk factor long, risk factor short)`.
