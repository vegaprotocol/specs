...
- Change of network parameter `market.fee.factors.treasuryFee` will, as soon as the current epoch ends, change the amount of `treasury_fee` that is transfered to the treasury fee pool for that asset. (<a name="0029-FEES-051" href="#0029-FEES-051">0029-FEES-051</a>)
