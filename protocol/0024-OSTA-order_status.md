...
- Order reason of `ORDER_ERROR_MARKET_CLOSED` when trying to send an order when the market is closed (<a name="0024-OSTA-018" href="#0024-OSTA-018">0024-OSTA-018</a>). For product spot the transaction result will be `Invalid Market ID` (<a name="0024-OSTA-044" href="#0024-OSTA-044">0024-OSTA-044</a>)
