...
| Name                                                     | Type     | Specification | Description                                                       | Validation | Version added  |  Acceprance Criteria| 
|----------------------------------------------------------|:--------:|---------------|-------------------------------------------------------------------|:---|--------:|--------:|
...
|`governance.proposal.asset.createFrom`                    | String (date) | [0003 - Limits](../non-protocol/specs/0003-limit-aka-training-wheels.md) | The date/time after which asset creation proposals are allowed. Before this they are rejected.|  - ||
...
|`governance.proposal.market.createFrom`                   | String (date) | [0003 - Limits](../non-protocol/specs/0003-limit-aka-training-wheels.md) | The date/time after which market creation proposals are allowed. Before this they are rejected.|  - ||
...
|`network.checkpoint.marketFreezeDate`                     | String (date) | [0005 - Limited Network Life](../non-protocol-specs/0005-NP-LIMN-limited_network_life.md) | The date before which all markets are expected to settle | | [:droplet: Sweetwater](../milestones/2.5-Sweetwater.md) ||
|`network.checkpoint.networkEndOfLifeDate`                 | String (date) | [0005 - Limited Network Life](../non-protocol-specs/0005-NP-LIMN-limited_network_life.md#network-parameters) | The point at which the chain will be shutdown || [:droplet: Sweetwater](../milestones/2.5-Sweetwater.md) ||
|`network.checkpoint.timeElapsedBetweenCheckpoints`        | String (duration) | [0005 - Limited Network Life](../non-protocol-specs/0005-NP-LIMN-limited_network_life.md#network-parameters) | The minimum time that should pass before another checkpoint is taken | | [:droplet: Sweetwater](../milestones/2.5-Sweetwater.md) ||
...
|`network.validators.ersatz.multipleOfTendermintValidators` | String (integer) | [0068 - Validators chosen by stake](./0069-VCBS-validators_chosen_by_stake.md#network-parameters) | Used to [calculate the number](./0069-VCBS-validators_chosen_by_stake.md#ersatz-validators) of ersatz validators that will earn rewards    |  network.validators.ersatz.multipleOfTendermintValidators - should be 0
network.validators.ersatz.rewardFactor - should be 0  | - | |
