...
|`market.liquidity.ghostPegDuration`                       | String (float)   | [0038 - Liquidity Provision Order](./0038-OLIQ-liquidity_provision_order_type.md ) | Maximum amount of time to use ghosts of best static bid / ask to post LP volume in absence of actual best static bid / ask before entering liquidity auction.  | Time between `0s` and `24h`. Default sensible value: `5m`. | TBD |
