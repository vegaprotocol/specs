...
|`limits.assets.proposeEnabledFrom`                    | String (date) | [0003 - Limits](../non-protocol/specs/0003-limit-aka-training-wheels.md) | The date/time after which asset creation proposals are allowed. Before this they are rejected.|  - |
...
|`limits.markets.proposeEnabledFrom`                   | String (date) | [0003 - Limits](../non-protocol/specs/0003-limit-aka-training-wheels.md) | The date/time after which market creation proposals are allowed. Before this they are rejected.|  - |
...
|`governance.proposal.updateAsset.maxClose` | String (duration) | [0027-ASSP-asset_proposal](./0027-ASSP-asset_proposal.md#modifying-an-existing-asset) | Each update asset proposal contains vote closing time which has to be before `current time + maxClose`. Possible value `24h`. | | - |
|`governance.proposal.updateAsset.maxEnact` | String | [0027-ASSP-asset_proposal](./0027-ASSP-asset_proposal.md#modifying-an-existing-asset) | Each proposal contains proposal enactment time which has to be before `current time + maxEnact`. Possible value `24h`. | | - |
|`governance.proposal.updateAsset.minClose` | String (duration) | [0027-ASSP-asset_proposal](./0027-ASSP-asset_proposal.md#modifying-an-existing-asset) | Each update asset proposal contains vote closing time which has to be after `current time + minClose`. Possible value `1h`. | | - |
|`governance.proposal.updateAsset.minEnact` | String (duration) | [0027-ASSP-asset_proposal](./0027-ASSP-asset_proposal.md#modifying-an-existing-asset) | Each proposal contains proposal enactment time which has to be after `current time + minEnact`. Possible value `2h`. | | - |
|`governance.proposal.updateAsset.minProposerBalance` | String (integer) | [0027-ASSP-asset_proposal](./0027-ASSP-asset_proposal.md#modifying-an-existing-asset) | Minimum [Governance token balance](/0028-GOVE-governance.md#restriction-on-who-can-create-a-proposal) required to make a asset update proposal | | - |
|`governance.proposal.updateAsset.minVoterBalance` | String (integer) | [0027-ASSP-asset_proposal](./0027-ASSP-asset_proposal.md#modifying-an-existing-asset) | Minimum [Governance token balance](/0028-GOVE-governance.md#restriction-on-who-can-create-a-proposal) required to make vote on an asset update proposal | | - |
|`governance.proposal.updateAsset.requiredMajority` | String (integer) | [0027-ASSP-asset_proposal](./0027-ASSP-asset_proposal.md#modifying-an-existing-asset) | 'Yes' votes must outnumber 'No' votes on this proposal by this proportion on an update asset proposal | | - |
|`governance.proposal.updateAsset.requiredParticipation` | String (float) | [0027-ASSP-asset_proposal](./0027-ASSP-asset_proposal.md#modifying-an-existing-asset) | The fraction of total token holders that must participate in a vote. Minimum `0.0`, maximum `1.0`, sensible value e.g. `0.25` | | - |
|`governance.proposal.updateMarket.minProposerEquityLikeShare` | String | [0028 - Governance](./0028-GOVE-governance.md) | Description required | | - |
|`governance.proposal.updateMarket.requiredMajorityLP` | String | [0028 - Governance](./0028-GOVE-governance.md) | Description required | | - |
|`governance.proposal.updateMarket.requiredParticipationLP` | String | [0028 - Governance](./0028-GOVE-governance.md) | Description required | | - |
...
|`market.auction.maximumDuration`                          | String (duration)  | [0026 - Auctions](./0026-AUCT-auctions.md#auction-config) | The longest duration an auction can be. Auctions that would be shorter (or [proposals that require a shorter auction](./0028-GOVE-governance.md#duration-of-the-proposal)) should not be started | | - |
...
|`market.liquidityProvision.shapes.maxSize`                | String (integer)| [0044 - LP Mechanics](./0044-LIME-lp_mechanics.md#network-parameters) | The upper limit of orders in an [LP commitment shape](./0044-LIME-lp_mechanics.md#orders-buy-shapesell-shape) | | [💃 Flamenco Tavern](../milestones/2-flamenco-tavern.md) |
|`market.liquidity.maximumLiquidityFeeFactorLevel`         | String (float) | [0044 - LP Mechanics](./0044-LIME-lp_mechanics.md#network-parameters) | The highest fee an [LP can offer](0044-LIME-lp_mechanics.md#fees) | | [💃 Flamenco Tavern](../milestones/2-flamenco-tavern.md) |
|`market.liquidity.providers.fee.distributionTimeStep`     | String (duration) | [0044 - LP Mechanics](./0044-LIME-lp_mechanics.md#network-parameters) | How frequently liquidity rewards are [distributed to LPs](./0042-LIQF-setting_fees_and_rewarding_lps.md#distributing-fees) | | [💃 Flamenco Tavern](../milestones/2-flamenco-tavern.md) |
...
|`market.liquidity.targetstake.triggering.ratio`           | String (float) | [0044 - LP Mechanics](./0044-LIME-lp_mechanics.md#network-parameters) |              | | [💃 Flamenco Tavern](../milestones/2-flamenco-tavern.md) |
...
|`market.liquidity.bondPenaltyParameter`                   |  String (float) | [0044 - LP Mechanics](./0044-LIME-lp_mechanics.md#network-parameters) | Scaling factor for [LP penalties in case of shortfall](./0044-LIME-lp_mechanics.md#penalties) | | [💃 Flamenco Tavern](../milestones/2-flamenco-tavern.md) |
|`market.liquidity.stakeToCcySiskas`                       | String (float)   | [0044 - Liquidity Provision Mechanics](./0044-LIME-lp_mechanics.md#network-parameters) | Translates a [Liquidity Commitment size](./0044-LIME-lp_mechanics.md#calculating-liquidity-from-commitment) to a [volume obligation](./0044-LIME-lp_mechanics.md#calculating-liquidity-from-commitment) | | - |
|`network.checkpoint.marketFreezeDate`                     | String (date) | [0005 - Limited Network Life](./0073-LIMN-limited_network_life.md) | The date before which all markets are expected to settle | | [:droplet: Sweetwater](../milestones/2.5-Sweetwater.md) |
|`network.checkpoint.networkEndOfLifeDate`                 | String (date) | [0005 - Limited Network Life](./0073-LIMN-limited_network_life.md#network-parameters) | The point at which the chain will be shutdown || [:droplet: Sweetwater](../milestones/2.5-Sweetwater.md) |
|`network.checkpoint.timeElapsedBetweenCheckpoints`        | String (duration) | [0005 - Limited Network Life](./0073-LIMN-limited_network_life.md#network-parameters) | The minimum time that should pass before another checkpoint is taken | | [:droplet: Sweetwater](../milestones/2.5-Sweetwater.md) |
|`network.floatingPointUpdates.delay` | String (duration) | [0065-FTCO-floating_point_consensus.md](./0065-FTCO-floating_point_consensus.md) | time-based trigger | | - |
...
|`reward.asset` | String | [0056-REWA-rewards_overview.md](./0056-REWA-rewards_overview.md) | Description |  | - |
|`reward.staking.delegation.maxPayoutPerEpoch` | String | [0061-REWP-pos_rewards.md](./0061-REWP-pos_rewards.md) | The maximum staking rewards paid out per epoch |  | - |
|`reward.staking.delegation.optimalStakeMultiplier` | String | [0061-REWP-pos_rewards.md](./0061-REWP-pos_rewards.md) | Description required |  | - |
|`reward.staking.delegation.payoutFraction` | String | [0061-REWP-pos_rewards.md](./0061-REWP-pos_rewards.md) | Description required |  | - |
|`rewards.marketCreationQuantumMultiple` | String | [0056-REWA-rewards_overview.md](./0056-REWA-rewards_overview.md#market-creation-reward-metrics) | Description required |  | - |
|`snapshot.interval.length` | String (integer) | [0009-NP-SNAP-snapshots.md](../non-protocol-specs/0009-NP-SNAP-snapshots.md) | The number of blocks between snapshots |  | - |
|`spam.pow.difficulty` | String (integer) | [0072-SPPW-spam-protection-PoW.md](./0072-SPPW-spam-protection-PoW.md) | Description required |  | - |
|`spam.pow.hashFunction` | String | [0072-SPPW-spam-protection-PoW.md](./0072-SPPW-spam-protection-PoW.md) | Description required |  | - |
|`spam.pow.increaseDifficulty` | String (integer) | [0072-SPPW-spam-protection-PoW.md](./0072-SPPW-spam-protection-PoW.md) | Description required |  | - |
|`spam.pow.numberOfPastBlocks` | String (integer) | [0072-SPPW-spam-protection-PoW.md](./0072-SPPW-spam-protection-PoW.md) | Description required |  | - |
|`spam.pow.numberOfTxPerBlock` | String (integer) | [0072-SPPW-spam-protection-PoW.md](./0072-SPPW-spam-protection-PoW.md) | Description required |  | - |
|`spam.protection.max.batchSize` | String (integer) | [0062 - Spam Protection](./0062-SPAM-spam_protection.md) | Description required |  | - |
|`spam.protection.maxUserTransfersPerEpoch` | String (integer) | [0062 - Spam Protection](./0062-SPAM-spam_protection.md) | Description required |  | - |
...
|`transfer.fee.factor` | String  | [0057-TRAN-transfers.md](./0057-TRAN-transfers.md) | A fee is taken from all transfers, and paid out to validators in a similar manner to the existing infrastructure fees.    |    | - |
|`transfer.minTransferQuantumMultiple` | String  | [0057-TRAN-transfers.md](./0057-TRAN-transfers.md#minimum-transfer-amount) | The minimum transfer amount calculated as `transfer.minTransferQuantumMultiple` x `quantum`    |    | - |
