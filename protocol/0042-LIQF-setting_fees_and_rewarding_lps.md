...
- `market.liquidityProvision.minLpStakeQuantumMultiple`: There is a netowrk wide parameter specifing the minimum LP stake as the `quantum` specified per asset, see [asset framework spec](../protocol/0040-ASSF-asset_framework.md).
