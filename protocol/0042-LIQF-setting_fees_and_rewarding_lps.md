...
- A vAMM which was active on the market with an average of `10000` liquidity units (`price * volume`) provided across the epoch, and where the `market.liquidity.stakeToCcyVolume` value is `100`, will have an implied commitment of `100`. (<a name="0042-LIQF-108" href="#0042-LIQF-091088">0042-LIQF-108</a>)
