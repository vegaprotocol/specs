...
- A vAMMs cancelled in a previous epoch does not receive anything and is not considered during SLA rebalancing at the end of an epoch(<a name="0042-LIQF-094" href="#0042-LIQF-094">0042-LIQF-094</a>)e
...
- A vAMM which was active when market is in opening auction, if they submit AMM with the same implied commitment as normal LP, then they should get the same liquidity fee as normal LP in the next epoch (<a name="0042-LIQF-112" href="#0042-LIQF-112">0042-LIQF-112</a>)
