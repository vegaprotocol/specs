...
| **3** | 🎥 Snapshotting | Limited Network Life is a stopgap - snapshots are a step towards validator set changes | [Project](https://github.com/orgs/vegaprotocol/projects/90) / </br> [Spec](./../non-protocol-specs/0009-NP-SNAP-snapshots.md)  | @core | Core |
