...
- **would like to** be able to search by market name, and see all keys with a margin or liquidity account in that market <a name="0001-WALL-030" href="#0001-WALL-030">0001-WALL-030</a>
...
- **must** see an option to base64 encode content before signing <a name="0001-WALL-063" href="#0001-WALL-063">0001-WALL-063</a>
   - **should** only have the option to broadcast valid Vega transactions to a selected network <a name="0001-WALL-XXX" href="#0001-WALL-XXX">0001-WALL-XXX</a>
