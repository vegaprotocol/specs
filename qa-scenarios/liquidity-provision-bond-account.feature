Feature: Replicate LP getting distressed during continuous trading, and after leaving an auction
  ...
  Background:
    ...
    And the markets:
      ...
      | ETH/MAR22 | ETH        | USD   | simple-risk-model-1 | default-margin-calculator | 1                | fees-config-1 | price-monitoring-1 | default-eth-for-future | 2021-12-31T23:59:59Z |
  ...
  Scenario: LP gets distressed during continuous trading
    ...
    Then the parties should have the following margin levels: 
      ...
      | party0 | ETH/MAR22 | 1100        | 1210   | 1320    | 1540     |
      | party1 | ETH/MAR22 | 1750        | 1925   | 2100    | 2450     |
    ...
    When the parties place the following orders:
      | party  | market id | side | volume | price | resulting trades | type       | tif     | reference      |
      | party3 | ETH/MAR22 | buy  | 3      | 1010  | 2                | TYPE_LIMIT | TIF_GTC | party3-buy-1   |
