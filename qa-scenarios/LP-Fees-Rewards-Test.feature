Feature: 1. Should cover liquidity-fee-setting and equity-like-share calc and total stake; 2.to look into and test: If an equity-like share is small and LP rewards are distributed immediately, then how do we round? (does a small share get rounded up or down, do they all add up?)
