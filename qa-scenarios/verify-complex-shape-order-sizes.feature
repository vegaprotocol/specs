...
Scenario:  Test LP Volume being pushed by limit of Probability of Trading (capped at 1e-8); 
#Price Monitoring has been removed as Prob in Price Monitoring only take up to 15 decimal places which will prevent scenatio which will trigger the ProbOfTrading cap at 1e-8
  ...
  # ProbOfTrading is capped at 1e-8 when LP pegged ref offset from 500 onward, we use 600 in this test case
