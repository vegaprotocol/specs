Feature: Verify the order size is correctly cumulated. As the price going away from mid price, the probability of trading is getting small, and the pegged volume is getting larger.
