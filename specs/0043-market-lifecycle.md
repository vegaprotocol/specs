...
![Life cycle diagram](./0043-market-lifecycle-flow-diagram.png)
...
[1] Accepting LPs: it is possible to make or amend [Liquidity Provision Commitments](./https://github.com/vegaprotocol/product/blob/master/specs/0044-lp-mechanics.md)
...
All Markets are first [proposed via the governance mechanism](./0028-governance.md#1-create-market). Once the valid Market Proposal is accepted *the Market (see [market framework](./0001-market-framework.md)) is created* and can accept [Liquidity Provision Commitments](./https://github.com/vegaprotocol/product/blob/master/specs/0044-lp-mechanics.md), voting begins and its state is `proposed`.

**Entry:**

- Valid [governance proposal](./0028-governance.md#1-create-market) submitted and accepted. For the avcoidance of doubt, this Proposal must include a (valid) specification of the Market and a Liquidity Commitment for at least the *minimum liquidity commitment (stake)*, which is a per asset Network Parameter.
